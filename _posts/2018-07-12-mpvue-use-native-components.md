title: 在mpvue中使用小程序原生自定义组件

date: 2018-07-12

author: 生忘

subtitle: 以一套小程序绘图组件Painter为例，简单介绍如何在mpvue中使用小程序原生自定义组件。
...
#### 前言
前几天把一个用于生成图片的、叫做painter的库开源了[https://juejin.im/post/5b40b158e51d4518f543c7b0](https://juejin.im/post/5b40b158e51d4518f543c7b0)，然后在评论区里发现，有不少人很关心能否在wepy或者mpvue框架里也使用它。
...
1. 安装mpvue，并新建项目。[http://mpvue.com/mpvue/quickstart/](http://mpvue.com/mpvue/quickstart/)
2. 编写所需要的页面：
...
7. 此时编译成功。在这里，Painter这个组件需要配合palette进行使用，palette里的代码是用来编写图片内容，具体用法可参考 [https://juejin.im/post/5b40b158e51d4518f543c7b0](https://juejin.im/post/5b40b158e51d4518f543c7b0) 。在项目/src/下创建palette目录，新建card.js文件。由于palette本身是js文件的形式，所以无需放在static中。
...
本文demo地址：[https://github.com/Kujiale-Mobile/Mpvue-Painter-Demo](https://github.com/Kujiale-Mobile/Mpvue-Painter-Demo)
